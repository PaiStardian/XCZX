...
public class MediaFileServiceImpl implements MediaFileService {
 ...
 public UploadFileResultDto uploadFile(Long companyId, UploadFileParamsDto uploadFileParamsDto, String localFilePath) {
  ...
  //文件mimeType类型
  String mimeType =getMinmeType(extension);
  //文件的md5值
 ...
 private String getMinmeType(String extension) {
  if(extension==null){
   extension = "";
  }
  //根据扩展名取出mimeType
 ...
 private String getFilerPathByMd5(String fileMd5, String extName) {
 ...
 public RestResponse uploadChunk(String fileMd5, int chunk, String localChunkFilePath) {
  ...
  //mimeType
  String mimeType = getMinmeType(null);
  //将文件存储至minIO
 ...
 public RestResponse mergechunks(Long companyId, String fileMd5, int chunkTotal, UploadFileParamsDto uploadFileParamsDto) {
  ...
  //合并文件路径
  String mergeFilePath = getFilerPathByMd5(fileMd5, extName);
  try {
   //合并文件
